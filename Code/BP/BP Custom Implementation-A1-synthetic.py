...
# Load the data
inputs = np.loadtxt('A1-synthetic.txt')[:, :9]
...
# Initialize and train the neural network with scaled data
neural_network = NeuralNetwork(input_size=9, hidden_size=12, output_size=1)
losses, _ = neural_network.train(inputs_train_scaled, targets_train_scaled, learning_rate=0.01, epochs=100)

# Predict using scaled inputs and inverse transform for plotting
